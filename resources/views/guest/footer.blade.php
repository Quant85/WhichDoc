<footer>
  <div class="container_footer d-flex ">
        <div class="left_footer">
           <div>
                <h2>WhichDoc </h2>
            <p>Considerato uno dei più importanti nel mondo, il Martha Children’s Hospital è una struttura sanitaria leader nella cura dei pazienti più giovani.</p>
           </div>
        </div>
        ...
        <div class="right_footer">
            <div>
                <h4>Dove siamo</h4>
                <p>Piazza San Carlo, 144, 00144-Roma RM</p>
            </div>
        </div>
  </div>
</footer>